...
export class ImageHub {
    ...
    static backgrounds = {
        ...
        lvl2: {
            layer_one: [
                './assets/img/5_background/layers/1_first_layer/2_1.png',
                './assets/img/5_background/layers/1_first_layer/2_1.png'
            ],
            layer_two: [
                './assets/img/5_background/layers/2_second_layer/2_2.png',
                './assets/img/5_background/layers/2_second_layer/2_2.png'
            ],
            layer_three: [
                './assets/img/5_background/layers/3_third_layer/2_3.png',
                './assets/img/5_background/layers/3_third_layer/2_3.png'
            ],
            clouds: [
                './assets/img/5_background/layers/4_clouds/2_1.png',
                './assets/img/5_background/layers/4_clouds/2_2.png'
            ],
            air: './assets/img/5_background/layers/sky.png',
        },  
        lvl3: {
            layer_one: [
                './assets/img/5_background/layers/1_first_layer/3_1.png',
                './assets/img/5_background/layers/1_first_layer/3_1.png'
            ],
            layer_two: [
                './assets/img/5_background/layers/2_second_layer/3_2.png',
                './assets/img/5_background/layers/2_second_layer/3_2.png'
            ],
            layer_three: [
                './assets/img/5_background/layers/3_third_layer/1.png',
            ...
            clouds: [
                './assets/img/5_background/layers/4_clouds/3_1.png',
                './assets/img/5_background/layers/4_clouds/3_2.png'
            ],
            air: './assets/img/5_background/layers/sky_3.png',
        },        
    };
    static statBars = {
        health: [
